...
// Logout
router.post("/logout", auth({ usersAllowed: [ROLE.ADMIN, ROLE.USER, ROLE.AGENT] }), controller.logout);

// SignUp only for user
router.post("/signup", validate(authValidation.signup), controller.signup);

// Send otp
router.post("/send-otp", validate(authValidation.sendOtp), controller.sendOtp);

// verify otp
router.post("/verify-otp", validate(authValidation.verifyOtp), controller.verifyOtp);

// change password
router.put("/change-password", validate(authValidation.changePassword), controller.changePassword);
